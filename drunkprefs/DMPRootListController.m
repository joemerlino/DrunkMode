#include "DMPRootListController.h"

@implementation DMPRootListController
	...
	-(void) sendEmail{
		[[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"mailto:merlino.giuseppe1@gmail.com?subject=DrunkMode"]];
	}
